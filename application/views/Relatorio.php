...
<head>
    ...
    <script src="../../IDS002-S1-2026-LiviaFerreiraDias/assets/js/jquery-3.6.0.min.js"></script>
    <script src="../../IDS002-S1-2026-LiviaFerreiraDias/assets/js/bootstrap.min.js"></script>
    <script src="../../IDS002-S1-2026-LiviaFerreiraDias/assets/js/sweetalert2.all.min.js"></script>
    ...
    <style>
        ...
        main { 
            margin-top: 150px; /* Ajuste conforme a altura do seu header */ 
        }
...
<body>
    ...
    const dadosTabela = document.getElementById('tabelaRelatorio')
    ...
    let conteudo = `
        <button class="btn-voltar" onclick="voltarParaPrincipal()">
            Voltar
        </button>

        <div class="btn-container">
            <button class="btn-periodo" onclick="filtrarPeriodo('manha')">
                Manhã
            </button>

            <button class="btn-periodo" onclick="filtrarPeriodo('tarde')">
                Tarde
            </button>

            <button class="btn-periodo" onclick="filtrarPeriodo('noite')">
                Noite
            </button>
        </div>
    ...
    for (let i = 0; i < dadosTabela.length; i++) {
        ...
        if (
            ...
            horario.includes('13:30')
        ) {
            periodo = 'tarde';
        } else if (
            horario.includes('Noite') ||
            horario.includes('19:00')
        ) {
            periodo = 'noite';
        }
    ...
    dadosOrdenados.forEach(dado => {
        ...
        conteudo += `
            <div class="card floor-${dado.andar}"
                 data-periodo="${dado.periodo}">
