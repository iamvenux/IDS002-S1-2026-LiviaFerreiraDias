    ...
    function filtrarTabela() {
        ...
        for (let i = 0; i < linhas.length; i++) {
            ...
            if (colDescricao) {
                ...
                const horaIniTexto = colHoraIni.textContent || colHoraIni.innerText;
                const horaFimTexto = colHoraFim.textContent || colHoraFim.innerText;

                if ((descricaoTexto.toLowerCase().indexOf(filter) > -1) ||
                    (horaIniTexto.toLowerCase().indexOf(filter) > -1) ||
                    (horaFimTexto.toLowerCase().indexOf(filter) > -1)) {
