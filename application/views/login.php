...
<head>
    ...
    <link rel="stylesheet" href="../../IDS002-S1-2026-LiviaFerreiraDias/assets/css/stylePassword.css">
...
<body>
    <div class="container">
        ...
        <div class="text-center">
            <img src="../../IDS002-S1-2026-LiviaFerreiraDias/assets/img/logo_fatecSR.png" alt="Logo da Empresa" style="max-width: 200px;
                margin-bottom: 20px;">
        </div>
